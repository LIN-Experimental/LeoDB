...
public interface ILeoDatabase : IDisposable
{
    /// <summary>
    ...
    /// </summary>
    ILeoStorage<string> FileStorage { get; }
    ...
    /// </summary>
    ILeoStorage<TFileId> GetStorage<TFileId>(string filesCollection = "_files", string chunksCollection = "_chunks");
