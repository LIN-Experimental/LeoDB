...
/// <summary>
/// The LeoDB database. Used for create a LeoDB instance and use all storage resources. It's the database connection
/// </summary>
public partial class LeoDatabase : ILeoDatabase
{
    #region Properties
    ...
    /// <summary>
    /// Starts LeoDB database using a generic Stream implementation (mostly MemoryStream).
    /// </summary>
    ...
    /// <summary>
    /// Start LeoDB database using a pre-exiting engine. When LeoDatabase instance dispose engine instance will be disposed too
    /// </summary>
    public LeoDatabase(ILeoEngine engine, BsonMapper mapper = null, bool disposeOnClose = true)
    {
