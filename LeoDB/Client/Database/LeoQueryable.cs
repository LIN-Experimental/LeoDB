...
/// </summary>
public class LeoQueryable<T> : ILeoQueryable<T>
{
    ...
    internal LeoQueryable(ILeoEngine engine, BsonMapper mapper, string collection, Query query)
    {
        _engine = engine;
        _mapper = mapper;
    ...
    /// </summary>
    public ILeoQueryable<T> Include<K>(Expression<Func<T, K>> path)
    {
    ...
    /// Load cross reference documents from path expression (DbRef reference)
    /// </summary>
    public ILeoQueryable<T> Include(BsonExpression path)
    {
    ...
    /// Load cross reference documents from path expression (DbRef reference)
    /// </summary>
    public ILeoQueryable<T> Include(List<BsonExpression> paths)
    {
    ...
    /// </summary>
    public ILeoQueryable<T> Where(BsonExpression predicate)
    {
    ...
    /// Filters a sequence of documents based on a predicate expression
    /// </summary>
    public ILeoQueryable<T> Where(string predicate, BsonDocument parameters)
    {
    ...
    /// Filters a sequence of documents based on a predicate expression
    /// </summary>
    public ILeoQueryable<T> Where(string predicate, params BsonValue[] args)
    {
    ...
    /// Filters a sequence of documents based on a predicate expression
    /// </summary>
    public ILeoQueryable<T> Where(Expression<Func<T, bool>> predicate)
    {
    ...
    /// </summary>
    public ILeoQueryable<T> OrderBy(BsonExpression keySelector, int order = Query.Ascending)
    {
    ...
    /// Sort the documents of resultset in ascending (or descending) order according to a key (support only one OrderBy)
    /// </summary>
    public ILeoQueryable<T> OrderBy<K>(Expression<Func<T, K>> keySelector, int order = Query.Ascending)
    {
    ...
    /// </summary>
    public ILeoQueryable<T> OrderByDescending(BsonExpression keySelector) => this.OrderBy(keySelector, Query.Descending);

    /// <summary>
    /// Sort the documents of resultset in descending order according to a key (support only one OrderBy)
    /// </summary>
    public ILeoQueryable<T> OrderByDescending<K>(Expression<Func<T, K>> keySelector) => this.OrderBy(keySelector, Query.Descending);
    ...
    /// </summary>
    public ILeoQueryable<T> GroupBy(BsonExpression keySelector)
    {
    ...
    /// </summary>
    public ILeoQueryable<T> Having(BsonExpression predicate)
    {
    ...
    /// </summary>
    public ILeoQueryableResult<BsonDocument> Select(BsonExpression selector)
    {
        _query.Select = selector;

        return new LeoQueryable<BsonDocument>(_engine, _mapper, _collection, _query);
    }

    /// <summary>
    /// Project each document of resultset into a new document/value based on selector expression
    /// </summary>
    public ILeoQueryableResult<K> Select<K>(Expression<Func<T, K>> selector)
    {
        ...
        return new LeoQueryable<K>(_engine, _mapper, _collection, _query);
    }
    ...
    /// </summary>
    public ILeoQueryableResult<T> ForUpdate()
    {
    ...
    /// </summary>
    public ILeoQueryableResult<T> Offset(int offset)
    {
    ...
    /// </summary>
    public ILeoQueryableResult<T> Skip(int offset) => this.Offset(offset);

    /// <summary>
    /// Return a specified number of contiguous documents from start of resultset
    /// </summary>
    public ILeoQueryableResult<T> Limit(int limit)
    {
        _query.Limit = limit;
        return this;
    }
