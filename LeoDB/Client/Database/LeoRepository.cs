...
/// <summary>
/// The LeoDB repository pattern. A simple way to access your documents in a single class with fluent query api
/// </summary>
public class LeoRepository : ILeoRepository
{
    ...
    /// </summary>
    public LeoRepository(ILeoDatabase database)
    {
        _db = database;
    }
    ...
    /// </summary>
    public LeoRepository(string connectionString, BsonMapper mapper = null)
    {
    ...
    /// Starts LeoDB database using a connection string for file system database
    /// </summary>
    public LeoRepository(ConnectionString connectionString, BsonMapper mapper = null)
    {
        _db = new LeoDatabase(connectionString, mapper);
    }

    /// <summary>
    /// Starts LeoDB database using a Stream disk
    /// </summary>
    public LeoRepository(Stream stream, BsonMapper mapper = null, Stream logStream = null)
    {
